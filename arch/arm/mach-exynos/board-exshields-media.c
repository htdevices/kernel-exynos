...
static struct s5p_mfc_platdata exshields_mfc_pd = {
	.clock_rate = 333 * MHZ,
};
...
static void __init exshields_media_sysmmu_init(void)
{
...
void __init exynos5_exshields_media_init(void)
{
	exshields_media_sysmmu_init();
	s5p_mfc_set_platdata(&exshields_mfc_pd);
